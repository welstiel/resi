...
> Vec<crate::models::GetCharactersCharacterIdCalendar200Ok> get_characters_character_id_calendar(character_id, datasource, from_event, if_none_match, token)
...
[**Vec<crate::models::GetCharactersCharacterIdCalendar200Ok>**](get_characters_character_id_calendar_200_ok.md)
...
> crate::models::GetCharactersCharacterIdCalendarEventIdOk get_characters_character_id_calendar_event_id(character_id, event_id, datasource, if_none_match, token)
Get an event
...
[**crate::models::GetCharactersCharacterIdCalendarEventIdOk**](get_characters_character_id_calendar_event_id_ok.md)
...
> Vec<crate::models::GetCharactersCharacterIdCalendarEventIdAttendees200Ok> get_characters_character_id_calendar_event_id_attendees(character_id, event_id, datasource, if_none_match, token)
Get attendees
...
[**Vec<crate::models::GetCharactersCharacterIdCalendarEventIdAttendees200Ok>**](get_characters_character_id_calendar_event_id_attendees_200_ok.md)
...
> put_characters_character_id_calendar_event_id(character_id, event_id, response, datasource, token)
Respond to an event
