...
pub struct GetCorporationsCorporationIdBookmarksCoordinates {
    /// x number
    #[serde(rename = "x")]
    pub x: f64,
    /// y number
...
impl GetCorporationsCorporationIdBookmarksCoordinates {
    /// Optional object that is returned if a bookmark was made on a planet or a random location in space.
    pub fn new(x: f64, y: f64, z: f64) -> GetCorporationsCorporationIdBookmarksCoordinates {
