...
impl GetCharactersCharacterIdOrdersHistory200Ok {
    /// 200 ok object
    pub fn new(duration: i32, is_corporation: bool, issued: String, location_id: i64, order_id: i64, price: f64, range: Range, region_id: i32, state: State, type_id: i32, volume_remain: i32, volume_total: i32) -> GetCharactersCharacterIdOrdersHistory200Ok {
