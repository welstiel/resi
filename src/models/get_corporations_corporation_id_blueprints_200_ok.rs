...
impl GetCorporationsCorporationIdBlueprints200Ok {
    /// 200 ok object
    pub fn new(item_id: i64, location_flag: LocationFlag, location_id: i64, material_efficiency: i32, quantity: i32, runs: i32, time_efficiency: i32, type_id: i32) -> GetCorporationsCorporationIdBlueprints200Ok {
