...
impl GetCharactersCharacterIdIndustryJobs200Ok {
    /// 200 ok object
    pub fn new(activity_id: i32, blueprint_id: i64, blueprint_location_id: i64, blueprint_type_id: i32, duration: i32, end_date: String, facility_id: i64, installer_id: i32, job_id: i32, output_location_id: i64, runs: i32, start_date: String, station_id: i64, status: Status) -> GetCharactersCharacterIdIndustryJobs200Ok {
