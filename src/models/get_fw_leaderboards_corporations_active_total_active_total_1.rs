...
pub struct GetFwLeaderboardsCorporationsActiveTotalActiveTotal1 {
...
impl GetFwLeaderboardsCorporationsActiveTotalActiveTotal1 {
    /// active_total object
    pub fn new() -> GetFwLeaderboardsCorporationsActiveTotalActiveTotal1 {
